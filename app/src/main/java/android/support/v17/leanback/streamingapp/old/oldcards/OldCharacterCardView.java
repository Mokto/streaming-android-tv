...
package android.support.v17.leanback.streamingapp.old.oldcards;
...
public class OldCharacterCardView extends BaseCardView {

    public OldCharacterCardView(Context context) {
